              ...
              <form action="{{route('save.banner')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="heading" placeholder="Enter banner heading">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="exampleInputEmail1" name="content" placeholder="Enter banner content"></textarea>
                  </div>
